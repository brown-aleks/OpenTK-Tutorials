...
namespace _4_Shaders
{
    public class Shader
    {
        ...
        public Shader(string vertPath, string fragPath)
        {
            ...
            // Теперь шейдер готов к работе, но сначала мы собираемся кэшировать все местоположения атрибутов и юниформ шейдера.
            ...
            // Нам нужно получить количество активных атрибутов в шейдере.
            ...
            // Нам нужно получить количество активных юниформ в шейдере.
