...
namespace _8_Cube_3D
{
    ...
    public class Window : GameWindow
    {
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            var model = Matrix4.Identity * Matrix4.CreateRotationY((float)MathHelper.DegreesToRadians(_time)) * Matrix4.CreateRotationX((float)MathHelper.DegreesToRadians(_time));
