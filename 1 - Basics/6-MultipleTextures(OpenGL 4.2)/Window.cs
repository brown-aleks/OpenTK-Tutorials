...
namespace _6_MultipleTextures
{
    public class Window : GameWindow
    {
        ...
        protected override void OnLoad()
        {
            ...
            // Обратите внимание на изменения в shader.frag там появился layout (binding=0). Который в шейдере указывает
            // к какому текстурному слоту привязывается переменная типа sampler2D. И теперь нет необходимости
            // нагружать основную программу установкой привязки через установщик униформы. Эта особенность появилась
            // начиная с версии OpenGL 4.2
